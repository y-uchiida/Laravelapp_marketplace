...
/* 現在選択されている画像の名前とIDを保持しておく変数の初期設定 */
$cImage = $currentImage ?? ''; /* null だった場合は空文字にする */
$cId = $currentId ?? ''; /* null だった場合は空文字にする */
@endphp
